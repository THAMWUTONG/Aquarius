        ...
        <div className="flex-1 p-8 overflow-y-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {filteredMaterials.map((material) => (
              <StudyMaterialCard key={material.id} id={material.id} courseName={material.courseTitle} title={material.title} topicName={material.topicTitle} description={material.description} type={material.fileType} tags={material.tags} prerequisites={material.prerequisites} downloadPath={material.filePath} initialIsBookmarked={material.isBookmarked} />
            ))}
          </div>
        </div>
      </main>
