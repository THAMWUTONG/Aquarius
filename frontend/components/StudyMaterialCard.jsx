...
function StudyMaterialCard({ id, courseName, title, topicName, description, type, initialIsBookmarked }) {
    ...
    <div className="p-6 border border-gray-300 rounded-xl shadow-md bg-white space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button disabled={loading} className={`p-2 border border-gray-300 rounded-lg hover:bg-gray-100 ${isBookmarked ? "bg-sky-100 text-sky-500 hover:bg-sky-200" : "bg-white"}`} onClick={handleToggle}><FaBookmark /></button>
